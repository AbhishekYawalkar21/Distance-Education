    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('instructor', models.ManyToManyField(to='myappF23.instructor')),
            ],
        ),
        migrations.CreateModel(
            name='Course',
            fields=[
                ...
                ('level', models.CharField(choices=[('BE', 'Beginner'), ('IN', 'Intermediate'), ('AD', 'Advanced')], default=None, max_length=10)),
